    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 opacity-0 animate-fade-in-delay-3">
          <a 
            href="#services" 
            className="px-8 py-3 bg-eco-600 text-white rounded-full font-medium hover:bg-eco-700 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1 group relative overflow-hidden"
          >
          ...
          <a 
            href="#contact" 
            className="px-8 py-3 border border-eco-600 text-eco-600 rounded-full font-medium hover:bg-eco-600 hover:text-white transition-all duration-300 group relative overflow-hidden"
          >
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 opacity-0 animate-fade-in-delay-3">
        <a 
          href="#services" 
          className="flex flex-col items-center text-foreground/60 hover:text-eco-600 transition-all duration-300 group"
        >
