...
const ServiceCard = ({
  ...
  return <div className={cn("glass rounded-lg p-8 transition-all duration-500 hover:shadow-lg hover:-translate-y-1 opacity-0 border-l-4 border-sky-300 hover:border-sky-400", index === 0 ? "animate-fade-in" : index === 1 ? "animate-fade-in-delay-1" : "animate-fade-in-delay-2")}>
...
const Services = () => {
  ...
  return <section id="services" className="py-24 relative overflow-hidden bg-gradient-to-b from-background via-sky-50/30 to-background">
