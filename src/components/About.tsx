...
const About: React.FC = () => {
  ...
  return (
    <div 
      id="about" 
      ref={aboutRef}
      className="py-12 relative bg-cover bg-center bg-no-repeat min-h-[600px] transition-all duration-1000 ease-in-out"
      style={{
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-12 bg-gradient-to-b from-white to-transparent z-10 transition-opacity duration-700"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="text-center mb-8 transform transition-all duration-700 hover:scale-[1.01] animate-on-scroll">
          <span className="inline-block text-sky-700 bg-sky-50/80 backdrop-blur-sm px-4 py-1.5 rounded-full text-sm font-medium mb-2 shadow-sm transition-all duration-500 hover:shadow-md hover:bg-sky-50/90">
            Nossa História
          </span>
          
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-earth-800 mb-2 transition-all duration-500 hover:text-earth-700">
