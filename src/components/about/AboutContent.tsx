...
export const AboutContent: React.FC = () => {
  return (
    <div className="space-y-6 text-center max-w-3xl mx-auto opacity-0 animate-fade-in-delay-2 p-8 rounded-xl bg-white/70 backdrop-blur-sm shadow-md border border-sky-100/50">
