...
const Banner = () => {
  ...
  return (
    <section 
      id="banner" 
      ref={bannerRef}
      className="py-4 bg-gradient-to-b from-white via-eco-50/30 to-eco-100/40 relative overflow-hidden transition-all duration-1000 ease-in-out"
    >
      ...
      <div className="container mx-auto relative z-20 mb-3 px-4">
        <div className="max-w-3xl mx-auto text-center space-y-3 animate-on-scroll">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-[#71B707] to-eco-300 mx-auto rounded-full my-3 transition-all duration-500 hover:w-32"></div>
      ...
      <div className="w-full relative overflow-hidden animate-on-scroll mt-1">
